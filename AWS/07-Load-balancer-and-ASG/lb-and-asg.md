# AWS Load Balancers & Auto Scaling Groups
...
## Part 2: Types of Load Balancers

###  AWS Has Four Load Balancers
...
## Part 9: Auto Scaling Group Core Concepts
...
## Part 10: Scaling Policies

###  Four Types of Scaling
...
###  Warm-Up Period (Target Tracking)
...
## Part 11: Instance Refresh (Rolling Updates)
...
## Part 14: Scaling Best Practices
...
## 🟢 Lab 1: BASIC — ALB with Two EC2 Instances
...
## 🟡 Lab 2: INTERMEDIATE — ALB Path-Based Routing + HTTPS
...
## 🔴 Lab 3: ADVANCED — Auto Scaling Group with Target Tracking + Instance Refresh
...
e Instance Refresh is a real production technique. Point out that this is how companies like Netflix do zero-downtime deployments. No blue/green, no canary — just rolling replacement.
