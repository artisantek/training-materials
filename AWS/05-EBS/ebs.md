...
## Part 1: What Problem Does EBS Solve?
...
## Part 2: EBS Volume Types — The Complete Guide
...
*"You tell AWS exactly how many IOPS you want, and AWS guarantees them. No bursting, no credits, no surprises."*
...
## Part 3: EBS Snapshots — Your Safety Net
...
## Part 5: EBS Modifications — Resize and Change Type Online
...
*"Two steps: 1) Modify the volume in AWS. 2) Extend the filesystem in Linux. The disk is bigger but the filesystem doesn't automatically expand."*
...
## Part 6: Detach, Reattach, and Delete on Termination
...
## Part 7: Amazon Data Lifecycle Manager (DLM) — Automated Snapshots
